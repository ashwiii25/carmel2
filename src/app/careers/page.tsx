          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-24">
            <div>
              ...
              <div className="space-y-6 mt-16">
                {JOBS.map((job) => (
                  <div key={job.title} className="group p-8 rounded-2xl bg-white border border-primary/5 hover:border-secondary/20 transition-all duration-500 hover:shadow-xl cursor-pointer">
